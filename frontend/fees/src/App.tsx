      ...
      <div className="flex min-h-screen flex-col items-center bg-gradient-to-br from-slate-50 via-white to-indigo-50 px-4 py-10 text-slate-900 md:py-16">
        <header className="mb-10 max-w-3xl text-center">
          <img
            ...
            alt={tenant?.name ?? 'EMS'}
          />
          <h1 className="text-3xl font-semibold tracking-tight text-slate-900 md:text-4xl">Fees Management</h1>
          <p className="mt-3 text-base text-slate-600 md:text-lg">Tenant aware interface for the fees management domain.</p>
        </header>
